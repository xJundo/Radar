...
Test(my_printf, flag_a_exposant_neg, .init = redirect_all_std)
{
    cr_assert(my_printf("%a", 0.5));
}

Test(my_printf, flag_a_exposant_pos, .init = redirect_all_std)
{
    cr_assert(my_printf("%a", 2.0));
}

Test(my_printf, flag_a_exposant_large, .init = redirect_all_std)
{
    cr_assert(my_printf("%a", 1024.0));
}

Test(my_printf, flag_a_exposant_small, .init = redirect_all_std)
{
    cr_assert(my_printf("%a", 0.0009765625));
}

Test(my_printf, flag_a_exposant_zero, .init = redirect_all_std)
{
    cr_assert(my_printf("%a", 1.0));
}
